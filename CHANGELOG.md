...
All notable changes to the Awesome Sites to Test On list will be documented in this file.
...
### Added
- [New Site Name](https://example.com) - Description of the site

### Removed
- [Old Site Name](https://example.com) - Reason for removal

### Changed
- Updated description for [Site Name](https://example.com)
-->
